...
uniform float vysecKlic;
uniform float vysecBarva;
...
void main() {
	...
	//definice pomocne promene (vysec)
	//vysec pro klicovani
	float pom = abs(z) / tan(vysecKlic);

	//vysec pro prebarveni
	float pom1 = abs(z) / tan(vysecBarva);
