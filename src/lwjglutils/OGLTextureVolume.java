...
public class OGLTextureVolume implements lwjglutils.OGLTexture {
	private final int volumeTextureID;
	private final int width, height, depth;
	
	public static class Viewer extends lwjglutils.OGLTexture2D.Viewer {
	...
	public <OGLTexImageType extends lwjglutils.OGLTexImage<OGLTexImageType>> OGLTextureVolume(OGLTexImageType volume) {
